    ...
    >
      <div className="hover:cursor-pointer group relative block overflow-hidden rounded-lg transition-all duration-500 hover:scale-105 bg-white hover:bg-black p-0.5">
        <div>
          ...
          <div className="absolute -bottom-96 group-hover:bottom-3 hover:text-white right-2 left-2 transition-all duration-500 bg-[#7a8eb0] border-solid-black border-2 dark:bg-slate-900 p-4 rounded-lg shadow dark:shadow-gray-700">
            <Typography
              gutterBottom
              variant="h5"
              component="div"
